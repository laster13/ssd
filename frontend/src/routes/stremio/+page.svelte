...
<div class="min-h-screen text-zinc-950 dark:text-white">
	<section class="relative overflow-hidden">
		...
		<div class="mx-auto max-w-7xl px-4 py-6 sm:px-6 sm:py-8 lg:px-8">
			<div
				class="relative overflow-hidden rounded-[34px] border border-black/5 bg-white/72 shadow-[0_30px_120px_rgba(15,23,42,0.10)] backdrop-blur-2xl dark:border-white/10 dark:bg-white/[0.04] dark:shadow-[0_30px_120px_rgba(0,0,0,0.38)] sm:rounded-[40px]"
			>
				<div class="pointer-events-none absolute inset-0">
					<div
						class="absolute inset-0 bg-[linear-gradient(135deg,rgba(56,189,248,0.06),rgba(37,99,235,0.04)_34%,rgba(168,85,247,0.06)_68%,rgba(16,185,129,0.05))]"
					></div>
					<div class="absolute inset-x-0 top-0 h-px bg-white/70 dark:bg-white/10"></div>
					<div class="absolute -left-20 top-10 h-52 w-52 rounded-full bg-sky-300/20 blur-3xl dark:bg-sky-400/10"></div>
				...
				<div class="relative p-5 sm:p-8 lg:p-10 xl:p-12">
					...
					{#if spotlightLink}
						<div class="mt-10">
							<div
								class="relative overflow-hidden rounded-[30px] border border-black/5 bg-white/80 p-6 shadow-[0_24px_60px_rgba(15,23,42,0.08)] dark:border-white/10 dark:bg-white/[0.05] dark:shadow-[0_18px_50px_rgba(0,0,0,0.24)] sm:p-8"
							>
								<div
					...
					<div class="mt-10 flex flex-col gap-4 xl:flex-row xl:items-center xl:justify-between">
					...
					<div class="mt-10">
						{#if !spotlightLink && filteredLinks.length === 0}
							<div
								class="rounded-[28px] border border-dashed border-black/10 bg-white/70 px-6 py-14 text-center text-zinc-500 dark:border-white/10 dark:bg-white/[0.03] dark:text-zinc-400"
							>
