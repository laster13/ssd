		...
		<div class="overflow-hidden rounded-[34px] border border-black/5 bg-white/75 shadow-[0_28px_100px_rgba(15,23,42,0.10)] backdrop-blur dark:border-white/10 dark:bg-white/[0.045] dark:shadow-[0_28px_100px_rgba(0,0,0,0.35)]">
			<div class="relative">
				...
				<div class="relative p-6 sm:p-8 lg:p-10">
					...
					{#if pairing}
						<div class="mt-8 rounded-[30px] border border-black/5 bg-white/80 p-5 shadow-[0_20px_60px_rgba(15,23,42,0.08)] dark:border-white/10 dark:bg-white/[0.05] dark:shadow-[0_20px_60px_rgba(0,0,0,0.22)]">
