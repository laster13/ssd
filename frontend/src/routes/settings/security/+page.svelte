...
<section class="mx-auto max-w-5xl py-8 sm:px-6 lg:px-8">
	...
	{#if requiredForAdmin}
		<div class="mb-5 border-y border-amber-200 bg-amber-50 px-4 py-4 text-amber-800 dark:border-amber-500/28 dark:bg-amber-500/[0.08] dark:text-amber-200 sm:rounded-[18px] sm:border">
			<strong>Accès admin protégé :</strong> active le 2FA pour pouvoir accéder à
			l’interface admin.
		</div>
	{/if}

	<div class="mb-6 border-y border-black/5 bg-white/70 px-4 py-4 dark:border-white/10 dark:bg-white/[0.04] sm:rounded-[18px] sm:border">
	...
	{#if !enabled}
		<section class="mb-5 border-y border-black/5 bg-white/60 px-4 py-5 dark:border-white/10 dark:bg-[rgba(15,23,42,0.45)] sm:rounded-[22px] sm:border sm:p-5">
			<div class="px-0">
	...
	{#if enabled}
		<section class="border-y border-black/5 bg-white/60 px-4 py-5 dark:border-white/10 dark:bg-[rgba(15,23,42,0.45)] sm:rounded-[22px] sm:border sm:p-5">
			<h2 class="text-xl font-semibold tracking-[-0.03em] text-zinc-950 dark:text-white">
				Désactiver le 2FA
			</h2>
