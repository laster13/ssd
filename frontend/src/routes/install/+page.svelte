...
<section class="relative overflow-x-hidden">
	...
	<div class="mx-auto max-w-6xl py-6 sm:px-6 sm:py-8 lg:px-8">
		...
		<div class="grid gap-6 xl:grid-cols-[minmax(0,1.08fr)_minmax(420px,0.92fr)] xl:items-start">
			<div class="border-y border-black/5 bg-white/75 backdrop-blur dark:border-white/10 dark:bg-white/[0.045] sm:overflow-hidden sm:rounded-[34px] sm:border sm:shadow-[0_28px_100px_rgba(15,23,42,0.10)] dark:sm:shadow-[0_28px_100px_rgba(0,0,0,0.35)]">
				<div class="relative">
					...
					<div class="relative px-4 py-5 sm:p-8 lg:p-10">
						<div class="min-w-0">
							<div
								class="mb-5 inline-flex max-w-full items-center gap-2 rounded-full border border-sky-200 bg-sky-50/90 px-3 py-1.5 text-[11px] font-semibold uppercase tracking-[0.16em] text-sky-700 dark:border-sky-400/20 dark:bg-sky-400/10 dark:text-sky-300"
							>
								<span class="h-2 w-2 shrink-0 rounded-full bg-sky-500"></span>
								<span class="truncate">Installation locale</span>
							</div>

							<h1
								class="max-w-2xl break-words text-2xl font-semibold tracking-[-0.03em] text-zinc-950 dark:text-white sm:text-3xl lg:text-[2.35rem] lg:leading-[1.08]"
							>
								<span
			...
			<div class="min-w-0 xl:sticky xl:top-6">
				<div class="border-y border-black/5 bg-white/80 px-4 py-5 shadow-[0_20px_60px_rgba(15,23,42,0.08)] dark:border-white/10 dark:bg-white/[0.05] dark:shadow-[0_20px_60px_rgba(0,0,0,0.22)] sm:rounded-[28px] sm:border sm:p-6">
					<div
		...
		<div class="mt-10 grid gap-4 xl:grid-cols-[minmax(0,1fr)_auto] xl:items-center">
			<div
				class="border-y border-black/5 bg-white/75 px-4 py-5 shadow-[0_14px_30px_rgba(15,23,42,0.05)] dark:border-white/10 dark:bg-white/[0.04] dark:shadow-none sm:rounded-[26px] sm:border sm:px-6"
			>
